...
pygame.display.set_caption("Битва с астероидами!")
...
def show_go_screen():
    ...
    draw_text(screen, "Press any key to begin", 18, int(WIDTH/2), int(HEIGHT*3/4))
    pygame.display.flip()
    waiting = True
    while waiting:
        clock.tick(FPS)
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.speedx = 0
        self.shield = 100
        # время между выстрелами в милисикундах
...
expl_sounds = []
kill_sound = pygame.mixer.Sound(path.join(snd_dir, 'rumble1.ogg'))
